...
function Main(){
  ...
  const this_1=(t.h.push(EventQ2(t.k, "registerhoudini", () => t.i, () => {
    const _3=null;
    StartImmediate(Delay(() => Bind(AsAsync(registerPaintWorklet()), () => Return(null))), null);
  })),t);
...
function registerPaintWorklet(){
  ...
  return new Promise((_2) => {
    _2(new Promise((_3) => {
      _3(globalThis.CSS.paintWorklet.addModule("paint-worklet.js").then(() => {
        statusMessage().Set("\u2705 Houdini Paint Worklet Registered!");
        return Promise.resolve(null);
      }));
    })["catch"]((d) => {
      const a=unwrapExn(d);
      statusMessage().Set("\u274c Error: "+String(a.message));
      return Promise.resolve(null);
    }));
  });
}
...
let _c=Lazy((_i) => class $StartupCode_Client {
  ...
  static {
    this.statusMessage=_c_1.Create_1("Click the button to register a custom Houdini paint worklet.");
  }
});
function NewGuid(){
